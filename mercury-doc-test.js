 ...
 * @property {respoke.SignalingChannel} signalingChannel A reference to the signaling channel.
 * @property {respoke.IdentityProvider} identityProvider A reference to the identity provider.
 * @property {function} chatMessage Class extending respoke.Message to use for chat messages.
 * @property {function} signalingMessage Class extending respoke.Message to use for signaling.
 * @property {function} presenceMessage Class extending respoke.Message to use for presence
 * messages.
 * @property {respoke.User} user Logged-in user's User object.
 * @copyright Digium 2013
 * @license Proprietary
 * {@link respoke.XMPPTextMessage}
 * {@linkcode respoke.XMPPTextMessage}
 * {@linkplain respoke.XMPPTextMessage}
 * {@link http://digium.com}
 * [Some caption]{@link http://digium.com}
 * {@link respoke.XMPPTextMessage some caption}
 * @mixes respoke.EventEmitter
 * @requires jQuery.js
...
DocumentationTest = function(params) {
	...
	that.appSettings = {
		 ...
		 * The constructor will search for them in the 'respoke' and 'window' namespaces
	...
	/**
	 * Find a configurable class in the respoke or window scopes and instantiate with the
	 * given params.
	...
	var findClass = function(className) {
		if (respoke[className]) {
			return respoke[className];
		}
		if (window[className]) {
	 ...
	 * @listens respoke.UserSession#disconnected
	 * @listens respoke.UserSession#disconnected2
	 * @throws no such attribute
	 * @throws divide by zero
	 * @fires respoke.User#logout
	 * @fires respoke.User#logout2
	 */
	 ...
	 * @returns {respoke.SignalingChannel} The instance of the respoke.SignalingChannel.
	 */
