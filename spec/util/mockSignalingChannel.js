...
window.mockedSignalingChannel = null;

window.MockSignalingChannel = function MockSignalingChannel(signalChannelParams) {
    'use strict';
    signalChannelParams = signalChannelParams || {};
    var that = respoke.EventEmitter(signalChannelParams);
    var Q = respoke.Q;
    var client = respoke.getClient(signalChannelParams.instanceId);
    var routingMethods = {};
    ...
    that.open = function (params) {
        ...
        deferred.resolve();
        that.connected = true;
        client.endpointId = params.endpointId || respoke.makeGUID();
        client.connectionId = respoke.makeGUID();
    ...
    window.mockedSignalingChannel = that;
    return that;
};
